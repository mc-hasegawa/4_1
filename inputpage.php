...
<form name="form_post" action="" method="post">
	...
	<label>1.全国地方公共団体コード<br><input type="text" name="input_public_group_code" value="<?php echo $input_array[0]; ?>"></label>
	</p>
	<p>
	<?php if (!$first_flag) {
		if ($input_array[1] == "") {
	...
	<label>2.旧郵便番号<br><input type="text" name="input_zip_code_old" value="<?php echo $input_array[1]; ?>"></label>
	</p>
	<p>
	<?php if (!$first_flag) {
		if ($input_array[2] == "") {
	...
	<label>3.郵便番号<br><input type="text" name="input_zip_code" value="<?php echo $input_array[2]; ?>"></label>
	</p>
	<p>
	<?php if (!$first_flag) {
		if ($input_array[3] == "") {
